...
aws ec2 run-instances --image-id ami-03265a0778a880afb --instance-type t2.micro --security-group-ids sg-073d40c36b7ddfbf2
...
do
    ...
    --security-group-ids sg-073d40c36b7ddfbf2
done
